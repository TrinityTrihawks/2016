...
public class I2CGyro {
    ...
    public static void initGyro() {
        ...
        /*
         * The gyroscope only gives us angular velocity so we need to integrate
         * it.
         */
    ...
    public static void pingGyro() {
         ...
         * it's angular position - Adjusted algorithms so that it is hopefully
         * less erratic
         */
        ...
        /*
         * Since an angle of more or less then 360 degrees makes little useful
         * sense we find remainder of the current position divided by 360
         */
    ...
    /**
     * Assigns piece of code that runs the pingGyro method constantly to pinger
     */
    ...
    /**
     * Gives the current angular position of the robot Returns a array of three
     * doubles
     *
     * @return angles
     */
