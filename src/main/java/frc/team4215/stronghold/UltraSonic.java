...
public class UltraSonic extends SensorBase {
    ...
    private double minVoltageINCH; // Minimum voltage the ultrasonic sensor can
                                   // return

    private double voltageRangeINCH; // The range of the voltages returned by
                                     // the sensor(maximum - minimum)

    private double minDistanceINCH; // Minimum distance the ultrasonic sensor
                                    // can return

    private double distanceRangeINCH;// The range of the distances returned by
                                     // this class(maximum - minimum)
    ...
    public UltraSonic(int channel_, boolean usingUnit_, double minVoltage_,
